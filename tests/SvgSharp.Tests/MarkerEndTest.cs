...
namespace Svg.UnitTests
{
    ...
    public class MarkerEndTest : SvgTestHelper
    {
        ...
        public void TestArrowCodeCreation()
        {
            ...
            {
                ID = "pathMarkerArrow",
                Fill = new SvgColorServer(new Color("black")),
            ...
            var line = new SvgLine()
            {
                ...
                EndX = 35,
                EndY = 35,
                Stroke = new SvgColorServer(new Color("black")),
                StrokeWidth = 3,
            ...
            var img = SvgSharp.SystemDrawing.SvgDocumentExtensions.Render(document).AsImage();
