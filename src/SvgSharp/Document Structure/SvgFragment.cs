        ...
        public SizeF GetDimensions()
        {
            ...
            if (isWidthperc || isHeightperc)
            {
                ...
                else
                {
                    ...
                    this.ViewBox = new SvgViewBox(bounds.Location.X, bounds.Location.Y, bounds.Size.Width, bounds.Size.Height);
                }
            }

            if (isWidthperc)
            {
                w = (bounds.Size.Width) * (Width.Value * 0.01f);
            }
            else
            {
            ...
            if (isHeightperc)
            {
                h = (bounds.Size.Height) * (Height.Value * 0.01f);
            }
            else
            {
