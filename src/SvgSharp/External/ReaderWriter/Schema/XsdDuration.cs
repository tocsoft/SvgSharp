    ...
    internal struct XsdDuration
    {
        ...
        internal string ToString(DurationType durationType)
        {
            ...
            if (durationType != DurationType.DayTimeDuration)
            {
                if (_years != 0)
                {
                    sb.Append(global::System.Xml.XmlConvert.ToString(_years));
                    sb.Append('Y');
                }

                if (_months != 0)
                {
                    sb.Append(global::System.Xml.XmlConvert.ToString(_months));
                    sb.Append('M');
                }
            }
            ...
            if (durationType != DurationType.YearMonthDuration)
            {
                if (_days != 0)
                {
                    sb.Append(global::System.Xml.XmlConvert.ToString(_days));
                    sb.Append('D');
                }
                ...
                if (_hours != 0 || _minutes != 0 || _seconds != 0 || Nanoseconds != 0)
                {
                    ...
                    if (_hours != 0)
                    {
                        sb.Append(global::System.Xml.XmlConvert.ToString(_hours));
                        sb.Append('H');
                    }

                    if (_minutes != 0)
                    {
                        sb.Append(global::System.Xml.XmlConvert.ToString(_minutes));
                        sb.Append('M');
                    }
                    ...
                    {
                        sb.Append(global::System.Xml.XmlConvert.ToString(_seconds));
                        if (nanoseconds != 0)
                        {
                            sb.Append('.');
